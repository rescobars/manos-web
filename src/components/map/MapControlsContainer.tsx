...
export function MapControlsContainer() {
  ...
  if (loading) {
    return (
      <div className="theme-bg-3/95 backdrop-blur-sm border theme-border rounded-lg shadow-lg p-4">
        <div className="text-center">
          <div className="animate-spin rounded-full h-6 w-6 border-b-2 border-blue-600 mx-auto mb-2"></div>
          <p className="text-xs theme-text-secondary">Cargando controles...</p>
        </div>
      </div>
    );
  }
